...
con.connect(function (err) {
  ...
  let sql =
    "CREATE TABLE IF NOT EXISTS pokemons (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), type VARCHAR(255), hp INT, defence INT, speed INT, weekness VARCHAR(255), imagelink VARCHAR(255))";
